...
from mindie_ais_bench_backend.models import TGICustomAPIStreamLora
...
models = [
    dict(
        ...
        generation_kwargs = dict( # 后处理参数参考TGI接口的官方文档
            min_new_tokens = 10,
            adapter_id = [], # Multi LoRA场景下，指定使用的随机lora-id，若为空list使用base模型名称

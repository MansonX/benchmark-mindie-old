...
from mindie_ais_bench_backend.models import MindieStreamTokenAPI
...
models = [
    dict(
        ...
        type=MindieStreamTokenAPI,
        abbr='mindie-stream-token',
        path="",
        request_rate = 0,
        retry = 2,
        ...
        generation_kwargs = dict( # 后处理参数参考mindie的官方文档
            ignore_eos = True,
        )
    )
]
...
work_dir = 'outputs/mindie-stream-token/'